function bigger_stack_size:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    ...
    "",\
    [{"text": "Datapack version: ", "color": "#00a800"}, {"text": "v2.4.2", "color": "#54fc54"}],\
    [{"text": "Game version: ", "color": "#00a800"}, {"text": "1.21.10+", "color": "#54fc54"}],\
    "",\
    [{"text": "By ", "color": "#fcfcfc"}, {"text": "Jodek", "color": "#fcfc54"}],\
    [{"text": "modrinth.com/datapack/bigger-stack-size", "color": "#a800a8"}],\
    "",\
    "",\
    "",\
    "",\
